...
import us.rjuhsd.ohs.OHSApp.tasks.ClassesTaskWidget;
...
public class ClassesOverviewAppWidgetProvider extends AppWidgetProvider {
	...
	private void doUpdate(Context context, AppWidgetManager appWidgetManager, int appWidgetId) {
		SharedPreferences prefs = context.getSharedPreferences(ClassesAppWidgetConfigure.PREF_PATH,0);
		String classesRaw = prefs.getString(ClassesAppWidgetConfigure.PREF_PREFIX+appWidgetId+"_Classes", "");
		...
		new ClassesTaskWidget(context, views, appWidgetManager, appWidgetId, classesRaw);
	}
